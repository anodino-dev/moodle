...
$plugin->version  = 2019101202;   // The (date) version of this module + 2 extra digital for daily versions
...
$plugin->component = 'local_log';
$plugin->cron     = 0;
$plugin->release = '1.0 (Build: 2019101202)';
