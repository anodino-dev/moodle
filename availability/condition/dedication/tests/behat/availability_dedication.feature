@availability @availability_dedication
Feature: availability_dedication
  ...
  Scenario: Max views must work with Assignment activity
    ...
    And I set the field "dedication" to "0"
    ...
    And I click on "Maximum Views" "button" in the "Add restriction..." "dialogue"
    And I click on ".availability-item .availability-eye img" "css_element"
    And I set the field "dedication" to "1"
    And I press "Save and return to course"
  ...
  Scenario: Max views must work with File resources
    ...
    And I upload "availability/condition/dedication/tests/fixtures/samplefile.txt" file to "Select files" filemanager
    And I expand all fieldsets
    And I click on "Add restriction..." "button"
    And I click on "Maximum Views" "button" in the "Add restriction..." "dialogue"
    And I click on ".availability-item .availability-eye img" "css_element"
